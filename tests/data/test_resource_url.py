...
class ResourceURLTestCase(unittest.TestCase):
    ...
    def test_resource_url(self):
        self.assertEqual('http://localhost:88/baseR4/ClinicalProfile?_format=json&_pretty=true',
                         self.do_test('jhu-asthma-lab-33.json'))
        self.assertEqual('http://localhost:88/baseR4/ClinicalProfile?_format=xml&_pretty=true',
                         self.do_test('jhu-asthma-lab-33.xml'))
        self.assertEqual('http://localhost:88/baseR4/ClinicalProfile?_format=ttl&_pretty=true',
